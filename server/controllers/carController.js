...
export const addCarController = async (req, res) => {
  try {
    ...
    const { model, details, rentalPrice, seats, mileage } = req.body;
...
export const updateCarController = async (req, res) => {
  try {
    const { _id, model, details, rentalPrice, seats, mileage } = req.body;
    ...
    if (req.file) {
      ...
      const updateObject = {
        ...
        seats: seats || existingCarData.seats,
        mileage: mileage || existingCarData.mileage,
